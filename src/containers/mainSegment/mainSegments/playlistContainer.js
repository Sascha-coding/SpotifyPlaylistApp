...
const Playlist = (props) => {
    ...
    return(
        <div className={styles.playlistContainer} onClick={(e) => props.selectPlaylist(playlistObj)}>
            <img className={styles.playlistImg} alt="Empty" src={playlistObj.playlistImage}></img>
